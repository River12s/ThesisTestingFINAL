...
TArray<FVector> UPoissonDiskSampling::DoPoissonDiskSampling(float Width, float Height, float Depth, float Radius, int32 MaxAttempts)
{
...
FVector UPoissonDiskSampling::GenerateRandomPointAround(const FVector& Point, float Radius, float MinDist, float MaxDist)
{
...
//Makes sure the point is valid
bool UPoissonDiskSampling::IsValidPoint(
                                        const FVector& Point,
                                        float Radius,
